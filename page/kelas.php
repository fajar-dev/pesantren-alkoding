        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="kelas.php" class="nav-link text-primary active">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($data['pemateri']); ?></td>
                                    <td><?php echo htmlentities($data['tanggal']); ?> </td>
                                    <td><a href="detail.php?id=<?php echo $data['id']; ?>" class="btn btn-info"><i class="nav-icon fas fa-search"></i> Detail Kelas</a></td>
                                </tr>
                                    <?php 
